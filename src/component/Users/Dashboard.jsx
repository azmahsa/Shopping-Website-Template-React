...
const Dashboard = ({ children }) => {
  ...
  console.log(user);
  const { username, firstName, lastName, gender, phone, email } = user;
                ...
                <div className="grid grid-cols-3">
                  ...
                  <div className="text-center my-2">
                    <img
                      ...
                      src="https://assets-global.website-files.com/63da3362f67ed649a19489ea/63e0bed303e95fe9a2089f20_western61.jpg"
                      alt=""
                    />
                    <a href="#" className="text-main-color">
                      Natie
